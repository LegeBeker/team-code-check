                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td class="align-middle"><?php echo ucfirst($row['person']); ?></td>
                                            <td class="align-middle"><?php echo $row['type']; ?></td>
                                            <td class="align-middle"><i class="fas fa-clock text-secondary"></i> <?php echo sprintf('%02d:%02d', floor($row['total_seconds'] / 3600), floor(($row['total_seconds'] - (floor($row['total_seconds'] / 3600) * 3600)) / 60)); ?></td>
                                            <td class="align-middle" title="<?php echo $row['end']; ?>"><?php echo date('Y/m/d', strtotime($row['end'])); ?></td>
                                            <td class="align-middle"><?php echo $row['branch']; ?></td>
                                            <td class="align-middle"><?php echo $row['comment']; ?></td>
                                            <td class="align-middle text-right">
